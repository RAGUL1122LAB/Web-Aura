...
export default function EventEssentials() {
  ...
  return (
    <div className="select-none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm sm:text-base font-gta-condensed font-bold uppercase tracking-wider text-gta-brown">
        <Link 
          to="/event" 
          onClick={handleLinkClick}
          className="hover:text-gta-orange hover:bg-gta-black px-2 py-1 border border-transparent hover:border-gta-black transition-none"
        >
        ...
        <Link 
          to="/winners" 
          onClick={handleLinkClick}
          className="hover:text-gta-orange hover:bg-gta-black px-2 py-1 border border-transparent hover:border-gta-black transition-none text-gta-green-dark"
        >
